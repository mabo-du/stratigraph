...
- [x] t032 Semantic Graph RAG — CIDOC-CRM triples via Oxigraph WASM for LLM ingestion #ai ~3h risk:high logged:2026-06-07
- [x] t033 Spatiotemporal Phasing & Bayesian Visualization — Calibrated C14 date axis on DAG #geochronology ~4h risk:high logged:2026-06-07
- [x] t034 Pleistocene Paleo-Coastline Mapping — GPlates API integration with time slider #paleo ~3h risk:med logged:2026-06-07

## Ready (no blockers)

<!-- Tasks with no open blockers — run /ready to refresh -->
<!-- All tasks completed. Consider adding new features or improvements. -->
